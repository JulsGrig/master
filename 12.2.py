...
my_ice_cream_stand = IceCreamStand("Чистая линия", "Кафе - Мороженое", "Северный пр. 1", "8:00 - 21:00 по будням, 9:00 - 22:00 по выходным")
...
my_ice_cream_stand.has_flavor("Черничное")

my_ice_cream_on_stick = IceCreamOnStick("Чистая линия", "Кафе - Мороженое", "Северный пр. 1", "8:00 - 21:00 по будням, 9:00 - 22:00 по выходным", "деревянные")
my_ice_cream_on_stick.display_stick_type()
my_ice_cream_on_stick.change_stick_type("пластиковые")

my_soft_serve = SoftServeIceCream("Чистая линия", "Кафе - Мороженое", "Северный пр. 1", "8:00 - 21:00 по будням, 9:00 - 22:00 по выходным",
